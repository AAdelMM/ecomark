...
<div class="menu flex-auto flex justify-center items-center  text-[#516091]" style="font-family: 'sky-bold'">
...
<div style="font-family: 'sky-bold';"><x-language-switcher /></div>
