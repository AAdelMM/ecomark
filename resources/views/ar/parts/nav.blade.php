...
<div class="nav container border-3  border-2 border-gray-100 rounded-lg flex items-center justify-between lg:justify-end ">
    ...
    <div class="menu hidden flex-auto lg:flex justify-center items-center">
        <ul class="inline-flex justify-center w-[70vw] text-[1.2rem] absolute font-bold text-[#516091]" style="font-family: 'sky-bold';">
            ...
            <li class="mx-2"><a href="#contact" class="menu-link">اتصل بنا</a></li>
            <li class="mx-2">التقييمات</li>
            <li class="mx-2"><a href="#team" class="menu-link">فريقنا</a></li>
            <li class="mx-2"><a href="#services" class="menu-link">الخدمات</a></li>
            <li class="mx-2"><a href="#hero" class="menu-link">الرئيسية</a></li>
        </ul>
 ...
 <button id="menu-toggle" class="lg:hidden text-gray-700 mx-2 focus:outline-none">
     ...
     <div id="mobile-menu" class="hidden lg:hidden bg-sky-100 w-[50%] absolute right-0 top-[4rem] text-center py-2 z-[5]">
        <ul class="text-[1rem] font-bold text-[#516091]">
            <li class="py-2"><a href="#hero" class="menu-link">الرئيسية</a></li>
            <li class="py-2"><a href="#services" class="menu-link">الخدمات</a></li>
            <li class="py-2"><a href="#team" class="menu-link">فريقنا</a></li>
            <li class="py-2">تقييمات</li>
            <li class="py-2"><a href="#contact" class="menu-link">اتصل بنا</a></li>
